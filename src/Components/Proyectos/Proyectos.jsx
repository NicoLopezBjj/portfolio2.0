        ...
        <div id="lastJob" className=' mt-5 mb-5  justify-content-center ancho'>
            ...
            <div className='row mt-5 d-flex flex-column w-60 '>
                <div className='col-12 proyecto m-2 '>
                    ...
                    <a href="https://shopcart-hmte.onrender.com/" target="_blank"><img className='img-fluid' src={image1} alt="" /></a>
                ...
                <div className='col-12 pt-5 proyecto m-2'>
                    <div className='d-flex align-items-center imgHover'>
                    <a href="https://github.com/NicoLopezBjj/pelis-mern/tree/pull-naiki" target="_blank" ><img className='img-fluid ' src={image2} alt="" /></a>
                ...
                <div className='col-12 pt-5 proyecto m-2'>
                    <div className='d-flex align-items-center imgHover'>
                    <a href="https://github.com/NicoLopezBjj/pelis-mern/tree/pull-naiki" target="_blank" ><img className='img-fluid ' src={image2} alt="" /></a>
                    <p className='colorGris ps-4 text-center d-flex align-items-center'>Blog desarrollado con MERN. Los usuarios pueden crear perfiles y seguir a otros usuarios, likear posts y comentarios. Trabajo en equipo, junto a un compañero. Manejo de versiones con GitHub y pull request.</p>
                    </div>
                </div>
                <div className='col-12 pt-5 proyecto m-2'>
                    <div className='d-flex align-items-center imgHover'>
