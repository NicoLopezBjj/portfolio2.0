    ...
    return (
        ...
        <div className="d-flex justify-content-between height fondo ps-lg-5">
            <div id="inicio" className='ms-5 d-flex flex-column justify-content-center'>
                ...
                <p className='gris mx-4 fontSizeB pb-2'>Estudiante de Desarrolo Web Front <br/> End  en la Universidad Tecnologica Nacional</p>
                <a href="#resumen"><button className="btn btn-primary color ms-4 border-0 px-4 py-2" href="#resumen">Sobre Mi</button></a> 
            </div>
            <div>
